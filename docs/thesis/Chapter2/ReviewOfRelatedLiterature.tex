...
\section{Long Short-term Memory Networks}
    ...
    \end{figure}
    Traditional RNNs have simple recurring layers. Figure 2.3 shows an example of an RNN with a tanh layer in its repeating module. In this network, the current input and the output of the previous layer will be fed to an tanh activation equation and the result will be the output for that layer.
...
\section{LSTM Structure}
    This section will walk through the structure and mechanics of an LSTM layer. The figures and equations that will follow will refer to these expressions from time to time.
        \begin{itemize}
    ...
    \subsection{Cell State}
        \begin{figure}[h]
        \centering
        \includegraphics[width=12cm]{LSTM3-C-line}
    ...
    \subsection{Forget Gate}
        \begin{figure}[h]
        \centering
        \includegraphics[width=12cm]{LSTM3-focus-f}
    ...
    \subsection{Input Gate}
        ...
        \begin{figure}[h]
        \centering
        \includegraphics[width=12cm]{LSTM3-focus-i}
        ...
        \begin{figure}[h]
        \centering
        \includegraphics[width=12cm]{LSTM3-focus-C}
    ...
    \subsection{Output Gate}
        \begin{figure}[h]
        \centering
        \includegraphics[width=12cm]{LSTM3-focus-o}
