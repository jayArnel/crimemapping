...
\section{Recommendations}
    ...
    There are also variations of Long Short-term Memory units. An example is the variation by Alex Graves \citeyearpar{graves2013generating}, which is more suitable to sequence labeling and time series data.