...
\subsection{Recurrent Neural Networks}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{RNN-unrolled}
...
\subsection{Long Short-term Memory Networks}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{LSTM3-SimpleRNN}
    ...
    \begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{LSTM3-chain}
...
\subsection{LSTM Structure}
    ...
    \subsubsection{Cell State}
        \begin{figure}[H]
        \centering
        \includegraphics[width=8cm]{LSTM3-C-line}
...
\subsection{Crime Recurrence}
    \begin{figure}[H]
        \centering
        \includegraphics[width=8cm]{crime-recurrence}
