...
\subsection{Error Analysis}
    ...
    \begin{figure}[H]
    \centering
    \subfloat[500mx500m, yearly]{\label{fig:a}\includegraphics[width=8cm]{500-yearly}} \\
    \subfloat[1000mx1000m, yearly]{\label{fig:b}\includegraphics[width=8cm]{1000-yearly}}
...
\subsection{Study Comparison}
  ...
  \begin{figure}[H]
      \centering
      \includegraphics[width=8cm]{750-monthly-both-studies}
